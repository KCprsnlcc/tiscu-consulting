...
export default function Hero() {
  return (
    <section className="max-w-7xl mx-auto px-6 pt-24 md:pt-32 mb-24 relative">
      ...
      <div className="absolute top-0 left-6 w-px h-full bg-tiscu-navy/5 hidden lg:block" />
      <div className="absolute top-0 right-6 w-px h-full bg-tiscu-navy/5 hidden lg:block" />
        ...
        <div className="lg:col-span-8">
          ...
          <FadeIn delay={0.2}>
            <p className="text-lg md:text-xl text-tiscu-steel max-w-2xl leading-relaxed font-light">
              ...
              <span className="text-tiscu-navy">+</span> Strategy Consulting.
